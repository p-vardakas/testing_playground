      ...
      <div className="bg-white rounded-lg max-w-2xl w-full">
        <div className="p-6 border-b">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-semibold text-gray-900" data-testid="cart-title">Shopping Cart</h2>
            <button
              onClick={onClose}
        ...
        <div className="p-6 border-t">
          <div className="flex justify-between items-center mb-4">
            <span className="text-lg font-medium text-gray-900" data-testid="cart-total-label">Total:</span>
            <span className="text-xl font-bold text-gray-900" data-testid="cart-total-amount">€{total.toFixed(2)}</span>
          </div>
          <button
            onClick={() => {
              onClose()
